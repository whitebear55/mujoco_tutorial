...
"""autogenerated by genpy from mujoco_ros_msgs/JointSet.msg. Do not edit."""
import codecs
import sys
...
class JointSet(genpy.Message):
  _md5sum = "e22f2239d2031a20304e67345beffc60"
  _type = "mujoco_ros_msgs/JointSet"
...
string frame_id
"""
  __slots__ = ['header','time','MODE','position','torque']
  _slot_types = ['std_msgs/Header','float64','int32','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,time,MODE,position,torque
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_di().pack(_x.time, _x.MODE))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time, _x.MODE,) = _get_struct_di().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length

...
"""autogenerated by genpy from mujoco_ros_msgs/JointState.msg. Do not edit."""
import codecs
import sys
...
class JointState(genpy.Message):
  _md5sum = "ce88c9ce3bee0cfdfb682b7f3434141d"
  _type = "mujoco_ros_msgs/JointState"
...
string frame_id
"""
  __slots__ = ['header','time','name','position','velocity','torque']
  _slot_types = ['std_msgs/Header','float64','string[]','float64[]','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,time,name,position,velocity,torque

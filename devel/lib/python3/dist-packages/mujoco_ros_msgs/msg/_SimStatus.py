...
"""autogenerated by genpy from mujoco_ros_msgs/SimStatus.msg. Do not edit."""
import codecs
import sys
...
class SimStatus(genpy.Message):
  _md5sum = "78d7999bef5de3a2f4c674bc813d9460"
  _type = "mujoco_ros_msgs/SimStatus"
...
float64[] data
"""
  __slots__ = ['header','time','name','position','velocity','effort','sensor']
  _slot_types = ['std_msgs/Header','float64','string[]','float64[]','float64[]','float64[]','mujoco_ros_msgs/SensorBase[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,time,name,position,velocity,effort,sensor
    ...
    """
    if args or kwds:
      super(SimStatus, self).__init__(*args, **kwds)
